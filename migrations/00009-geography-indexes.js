...
export async function up(sql) {
  await sql`CREATE INDEX routing_nodes_geography_idx ON routing_nodes USING GIST ((geom::geography))`;
  await sql`CREATE INDEX rooms_centroid_geography_idx ON rooms USING GIST ((centroid::geography))`;
}
